    ...
    public SqlFunctionExpression? Translate(MethodInfo method, IReadOnlyList<SqlExpression> arguments, IDiagnosticsLogger<DbLoggerCategory.Query> logger)
    {
        ...
        switch (methodInfo.Name)
        {
            ...
            case nameof(RelationalWindowAggregateFunctionExtensions.Average)
                ...
                return _sqlExpressionFactory.Function("AVG", BuildCaseExpression(), true, [false], arguments[0].Type, arguments[0].TypeMapping);
            ...
            case nameof(RelationalWindowAggregateFunctionExtensions.Count)
                ...
                return _sqlExpressionFactory.Function("COUNT", BuildCaseExpression(_sqlExpressionFactory.Constant("1")), true, [false], typeof(int));
            ...
            case nameof(RelationalWindowAggregateFunctionExtensions.Count)
                ...
                return _sqlExpressionFactory.Function("COUNT", BuildCaseExpression(), true, [false], typeof(int));
            ...
            case nameof(RelationalWindowAggregateFunctionExtensions.CumeDist)
                ...
                return _sqlExpressionFactory.Function("CUME_DIST", Enumerable.Empty<SqlExpression>(), false, [false], typeof(double));
            ...
            case nameof(RelationalWindowAggregateFunctionExtensions.DenseRank)
                ...
                return _sqlExpressionFactory.Function("DENSE_RANK", Enumerable.Empty<SqlExpression>(), false, [false], typeof(long));
            ...
            case nameof(RelationalWindowAggregateFunctionExtensions.Lag)
                ...
                return _sqlExpressionFactory.Function("LAG", arguments, true, [false], arguments[0].Type, arguments[0].TypeMapping);
            ...
            case nameof(RelationalWindowAggregateFunctionExtensions.Lead)
                ...
                return _sqlExpressionFactory.Function("LEAD", arguments, true, [false], arguments[0].Type, arguments[0].TypeMapping);
            ...
            case nameof(RelationalWindowAggregateFunctionExtensions.Max)
                ...
                return _sqlExpressionFactory.Function("MAX", BuildCaseExpression(), true, [false], arguments[0].Type, arguments[0].TypeMapping);
            ...
            case nameof(RelationalWindowAggregateFunctionExtensions.Min)
                ...
                return _sqlExpressionFactory.Function("MIN", BuildCaseExpression(), true, [false], arguments[0].Type, arguments[0].TypeMapping);
            ...
            case nameof(RelationalWindowAggregateFunctionExtensions.PercentRank)
                ...
                return _sqlExpressionFactory.Function("PERCENT_RANK", Enumerable.Empty<SqlExpression>(), false, [false], typeof(double));

            case nameof(RelationalWindowAggregateFunctionExtensions.Rank)
                when methodInfo == RelationalWindowAggregateMethods.Rank:

                return _sqlExpressionFactory.Function("RANK", Enumerable.Empty<SqlExpression>(), false, [false], typeof(long));
            ...
            case nameof(RelationalWindowAggregateFunctionExtensions.RowNumber)
                ...
                return _sqlExpressionFactory.Function("ROW_NUMBER", Enumerable.Empty<SqlExpression>(), false, [false], typeof(long));
            ...
            case nameof(RelationalWindowAggregateFunctionExtensions.Sum)
                ...
                return _sqlExpressionFactory.Function("SUM", BuildCaseExpression(), true, [false], arguments[0].Type, arguments[0].TypeMapping);
        }

        return null;

        CaseExpression[] BuildCaseExpression(SqlExpression? result = null)
            => [_sqlExpressionFactory.Case([new CaseWhenClause(ProcessCaseWhen(arguments[result == null ? 1 : 0]), result ?? arguments[0])], _sqlExpressionFactory.Constant(null))];

        SqlExpression ProcessCaseWhen(SqlExpression whenExpression)
        {
