...
namespace Microsoft.EntityFrameworkCore.Internal
{
    ...
    public static class RelationalStrings
    {
        ...
        /// </summary>
        public static string DbFunctionTableValuedFunctionMustReturnIQueryable([CanBeNull] object function)
            => string.Format(
                GetString("DbFunctionTableValuedFunctionMustReturnIQueryable", nameof(function)),
                function);
