...
namespace Microsoft.EntityFrameworkCore.Internal
{
    ...
    public static class CoreStrings
    {
        ...
        /// <summary>
        ///     Cannot set '{baseType}' as the base type of '{derivedType}'. Inheritance hierarchies cannot contain a mix of entity types and view types.
        /// </summary>
        public static string ErrorMixedViewEntityTypeInheritance([CanBeNull] object baseType, [CanBeNull] object derivedType)
            => string.Format(
