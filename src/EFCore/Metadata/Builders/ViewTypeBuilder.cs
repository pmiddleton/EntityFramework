...
namespace Microsoft.EntityFrameworkCore.Metadata.Builders
{
    /// <summary>
    ///     <para>
    ///         Provides a simple API for configuring a view type.
    ///     </para>
    ///     <para>
    ...
    ///     </para>
    /// </summary>
    public class ViewTypeBuilder : IInfrastructure<IMutableModel>, IInfrastructure<InternalEntityTypeBuilder>
    {
        /// <summary>
        ...
        public virtual ViewTypeBuilder HasAnnotation([NotNull] string annotation, [NotNull] object value)
        {
        ...
        /// <returns> The same builder instance so that multiple configuration calls can be chained. </returns>
        public virtual ViewTypeBuilder HasBaseType([CanBeNull] string name)
        {
            return new ViewTypeBuilder(Builder.HasBaseType(name, ConfigurationSource.Explicit));
        }
