...
namespace Microsoft.EntityFrameworkCore.Query.DbFunctions.Internal.Initializers
{
    ...
    /// </summary>
    public class SqliteStringInitializer : IDbFunctionInitializer
    {
        /// <summary>
        ///     This API supports the Entity Framework Core infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        ...
        public virtual void Initialize(ModelBuilder modelBuilder)
        {
            ...
            var subStringMi = typeof(string).GetTypeInfo().GetDeclaredMethods(nameof(string.Substring));
            ...
            var trimMi = typeof(string).GetTypeInfo().GetDeclaredMethods(nameof(string.Trim));
