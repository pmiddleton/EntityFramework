...
public class SqlServerWindowAggregateMethodTranslator : RelationalWindowAggregateMethodTranslator
{
    ...
    public override SqlFunctionExpression? Translate(MethodInfo method, IReadOnlyList<SqlExpression> arguments, IDiagnosticsLogger<DbLoggerCategory.Query> logger)
    {
