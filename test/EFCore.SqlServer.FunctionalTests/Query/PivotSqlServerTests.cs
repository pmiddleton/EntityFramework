...
namespace Microsoft.EntityFrameworkCore.Query
{
    public class PivotSqlServerTests : IClassFixture<PivotSqlServerTests.SqlServerPivotFixture>
    {
        ...
        public class SqlServerPivotFixture : SharedStoreFixtureBase<PoolableDbContext>
        {
    ...
    @"CREATE VIEW View_SchoolPlayer AS 
       ...
       #region Tests
        ...
        public void PivotSimpleSelectEntity()
        {
            using (var context = CreateContext())
            {
                ...
                var results = context.Schools.Select(s => new { s.Attendence, s.Name })
                                                .Pivot(s => s.Name,
       ...
       */
        ...
        protected class PivotSqlContext : PoolableDbContext
        {
            #region DbSets
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder)
            {
                ...
                var ps = modelBuilder.Query(typeof(PivotSchool));
                ps.Property("Wisconsin").IsPivot();
                ps.Property("Minnesota").IsPivot();
                ps.Property("Oklahoma").IsPivot();
                ps.Property("Alabama").IsPivot();
