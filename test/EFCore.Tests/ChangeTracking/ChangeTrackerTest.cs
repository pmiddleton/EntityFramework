    ...
    public class ChangeTrackerTest
    {
        ...
        public void View_type_negative_cases()
        {
            using (var context = new EarlyLearningCenter())
            {
                ...
                Assert.Equal(
                    CoreStrings.ViewTypeNotValid("WhoAmI"),
                ...
                Assert.Equal(
                    CoreStrings.InvalidSetTypeView("WhoAmI"),
                ...
                Assert.Equal(
                    ...
                    Assert.Throws<InvalidOperationException>(() => context.View<Sweet>().ToList()).Message);
